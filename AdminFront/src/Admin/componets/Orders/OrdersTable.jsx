        ...
        <div className="">
          ...
          >
            ...
            <div className="max-h-[90vh] overflow-y-auto p-6">
              ...
              <hr className="my-4" />
              {/* User Info */}
              <h3 className="text-lg font-semibold">{selectedOrder.isGuestOrder ? "Guest Info" : "Customer"}</h3>
              {selectedOrder.isGuestOrder ? (
                <>
                  ...
                  <Chip label="Guest Order" size="small" color="warning" sx={{ mt: 1, fontWeight: "bold" }} />
                </>
              ) : (
                <>
              ...
              <TableBody>
                {paidOrders.map((item, index) => (
                  ...
                  >
                      ...
                      <Box sx={{ display: "flex", flexDirection: "column" }}>
                        ...
                        {item.isGuestOrder && (
                          <Chip
                            ...
                            size="small"
                            color="warning"
                            sx={{ marginTop: "4px", fontSize: "0.7rem", height: "20px", fontWeight: "bold" }}
                          />
                        )}
                        {/* COD Badge */}
                    ...
                    {/* Payment Button — hidden for guest orders */}
                    <TableCell>
                      {!item.isGuestOrder && item.user?._id ? (
                        <Button
                          variant="outlined"
                          size="small"
